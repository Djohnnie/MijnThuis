            ...
            try
            {
                ...
                if (carLocation.Location == "Thuis" && carOverview.IsChargePortOpen)
                {
                    ...
                    if (collectedSolarPower.Count >= numberOfSamplesToCollect)
                    {
                        ...
                        maxPossibleCurrent = maxPossibleCurrent > carOverview.MaxChargingAmps ? carOverview.MaxChargingAmps : (int)maxPossibleCurrent > 2 ? maxPossibleCurrent - 1 : maxPossibleCurrent;
