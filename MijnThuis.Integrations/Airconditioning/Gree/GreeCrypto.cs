...
/// </summary>
internal static class GreeCrypto
{
    /// <summary>
    /// The generic AES key shared by all devices for ECB-mode binding.
    /// </summary>
    public const string GenericKey = "a3K8Bx%2r8Y7#xDh";

    /// <summary>
    /// The generic AES key shared by all devices for GCM-mode binding.
    /// </summary>
